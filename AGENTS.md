...
This repo currently contains only a **design handoff bundle** exported from Codex Design (Codex.ai/design) — there is no implementation yet, and no package manager, build, lint, or test tooling exists. `README.md` at the root explains the handoff; read it before doing anything else.
