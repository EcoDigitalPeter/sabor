...
- `redactor-pt-pt-pre-ao90` (`.claude/skills/`) — obrigatória ao implementar qualquer string/label vinda de parecer de copy, para não introduzir erros de grafia/AO90 na tradução spec→código
